...
// Posiciones por defecto, similares a las líneas rojas que marcaste
const DEFAULT_POSITIONS = [
  { bottom: '-20%',  right: '119%',  rotate: '-3deg' },  // arriba-izquierda
  { bottom: '-20%', right: '4%',  rotate: '2deg'  },  // medio-izquierda
  { bottom: '-20%', right: '32%', rotate: '-2deg' },  // derecha
  { bottom: '-20%', right: '74%', rotate: '3deg' }, // abajo-derecha
];

const WavePhrases = ({ positions = DEFAULT_POSITIONS }) => {
  const phrases = [
    "Ayuda a fortalecer la raíz.",
    "Nutre el cuero cabelludo.",
    "Favorece un crecimiento más saludable.",
    "Fácil de usar."
  ];
